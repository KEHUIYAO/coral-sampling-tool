...
mysim = Simulation(area,point_process_type,disease_prevalence,coral_size,coral_size_sd,n_toolkit_candidate[0],toolkit_length,toolkit_width,line_intercept_ratio,prop_cover=prop_cover)

power_comparison_using_different_number_of_toolkits(mysim,n_toolkit_candidate,repeat,write_to_csv=True)

# mysim.plot(dpi=200,alpha = 0.1)